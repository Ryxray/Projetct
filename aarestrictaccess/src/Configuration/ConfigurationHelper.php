...
namespace Aality\RestrictAccess\Configuration;
...
class ConfigurationHelper
{
    ...
    private function initFields()
    {
        $this->fields = [
            [
                'name'     => 'AALITY_EXEMPLE_TEXT',
                'type'     => 'text',
                'label'    => $this->module->l('EXEMPLE'),
                'required' => true,
            ],
            [
                'name'          => 'AALITY_IMAGE',
                ...
                'required'      => false,
                'desc'          => $this->module->l('Recommended image size: 1920 x 1080'),
                'display_image' => true,
                'thumb'         => \Context::getContext()->shop->getBaseURL() . '/modules/' . $this->module->name . '/uploads/' . Configuration::get('AALITY_IMAGE'),
            ],
        ];
    }
